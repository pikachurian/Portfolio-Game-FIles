...
function DrawBgStatic()
{
	...
	{
		draw_sprite(bgStatic.sprite,0,0,0)
	}
}
...
function DrawBgScrolling2()
{
	...
	a2 -= bgScrolling2.scrollSpd//1//14//14//18//28//7//14
	//a /= 2
	//a2 = clamp(a2,0,room_width)
	if(a2 < 0)a2 = room_width
	if(a2 > room_width)a2 = 0
	//a2 = room_width/2
...
function DrawScrolling1ScrollToPlayer()
{
	...
	draw_sprite(_sprite,image_index,_x1,0)
	draw_sprite(_sprite,image_index,_x2,0)
	draw_sprite(_sprite,image_index,_x3,0)
	draw_sprite(_sprite,image_index,_x4,0)
