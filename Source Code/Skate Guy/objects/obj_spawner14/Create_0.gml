...
mid = {
	...
	spawnTime : room_speed * 0.75,
	spawnTick : room_speed * 0.75
}
...
function ZoneUpdate(_zone)
{
	if(zone.spawnTick <= 0)
	{
		...
		with(_inst)
		{
			...
			spd += _roll
			if(other.zone = other.low)_roll = random_range(other.camY-128,other.camY+other.camH-128)
			else _roll = random_range(other.camY-240,other.camY+other.camH+240)
