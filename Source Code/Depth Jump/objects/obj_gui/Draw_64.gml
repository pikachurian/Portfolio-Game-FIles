...
if(room = rm_1_0)
{
	...
	draw_text_transformed(96,38,string(obj_player_stats.coins_level_0) + "/1",2,2,1)
	draw_set_color(c_white)
	draw_text_transformed(99,40,string(obj_player_stats.coins_level_0) + "/1",2,2,1)
}
...
if(room = rm_2_1)
{
	draw_set_color(c_black)
	//draw_text_ext_transformed(96,64,obj_player_stats.coins_level_0,1,1,2.5,2.5,1)
	draw_text_transformed(96,38,string(obj_player_stats.coins_level_2) + "/3",2,2,1)
	draw_set_color(c_white)
	draw_text_transformed(99,40,string(obj_player_stats.coins_level_2) + "/3",2,2,1)
}
